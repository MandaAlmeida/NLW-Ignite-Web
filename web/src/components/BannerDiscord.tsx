  ...
  return (
    <>
      ...
      <div
        className={
          props.active
            ? "fixed flex flex-col bg-[#2A2634] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-3/4 max-w-2xl p-8"
            : "hidden"
        }
      >
        <button
        ...
        <div className="flex flex-col items-center  gap-6">
          ...
          <section className="text-center">
            <h4 className="text-white text-4xl font-black">Let's play!</h4>
          ...
          <section className="text-center flex flex-col gap-2">
            ...
            <span className="text-zinc-400 text-2xl bg-zinc-900 py-3 px-4 rounded">
              {props.text}
            </span>
          </section>
        </div>
