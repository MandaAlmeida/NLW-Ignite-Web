...
export function CreateAdBanner() {
  return (
    <div className="pt-1 sm:w-[90%] sm:my-5 sm:mx-auto bg-nlw-gradient self-stretch rounded-lg  lg:mt-8 overflow-hidden">
      <div className="bg-[#2A2634]  lg:px-5 lg:py-3 sm:px-4 sm:py-4 rounded-t-lg flex justify-between items-center">
        ...
        <Dialog.Trigger className=" lg:py-1 lg:px-2 sm:py-3 sm:px-3 bg-violet-500 hover:bg-violet-600 text-white rounded flex items-center gap-3">
